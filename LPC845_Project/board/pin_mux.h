...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_IR_LED_EN_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_IR_LED_EN_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_IR_LED_EN_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_IR_LED_EN_PIN 0U                   /*!<@brief PORT pin number */
