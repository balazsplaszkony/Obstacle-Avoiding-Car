...
- {id: UART0_clock.outFreq, value: 15 MHz, locked: true, accuracy: '0.001'}
- {id: UART1_clock.outFreq, value: 15 MHz, locked: true, accuracy: '0.001'}
...
- {id: SYSCON.UART1CLKSEL.sel, value: SYSCON.fro_div_div2}
...
void BOARD_BootClockFRO18M(void)
{
    ...
    CLOCK_Select(kUART1_Clk_From_Fro_Div);                 /*!< select FRO_DIV for UART1 */
